...
import FilterRecordingsByClientModal from "./FilterRecordingsByClientModal";
import FilterRecordingsByFolderModal from "./FilterRecordingsByFolderModal";
...
export default function FiltersBar() {
  ...
  const { clientFilter, allRecordings, folderFilter } = useRecordings();

  const disabled = !allRecordings || allRecordings.length === 0;

  return (
    <>
      <FilterRecordingsByClientModal
        isVisible={isClientFiltersModalVisible}
        onClose={() => setIsClientFiltersModalVisible(false)}
      />
      <FilterRecordingsByFolderModal
